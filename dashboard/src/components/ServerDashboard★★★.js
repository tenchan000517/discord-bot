    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="p-8 bg-white rounded-lg shadow-sm">
          ...
          >
            <img src="/discord-logo.svg" alt="" className="w-6 h-6" />
            Discordでログイン
          </button>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <div className="text-3xl font-bold">
                  {serverData.rankings.reduce((sum, user) => sum + user.points.total, 0).toLocaleString()}
                </div>
                <p className="text-gray-500">{serverData.settings.global_settings.point_unit}</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm">
        ...
        <div className="max-w-[1920px] mx-auto px-6 py-4">
          <div className="flex items-center justify-between gap-4">
            <select
              ...
              className="w-96 px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
            >
                        ...
                        return (
                          <button
                            ...
                            onClick={() => {
                              ...
                              setEditingSection(null); // メニュー選択時は表示モードのまま
                            }}
                            className={`w-full flex items-center px-4 py-3 rounded-lg text-left transition-colors ${selectedMenu === item.id
