...
const FeatureSettings = ({
    ...
    const featureSettingsData = useMemo(() => {
        ...
        // ポイント消費設定のデフォルト値
        const defaultPointConsumption = {
            enabled: false,
            button_name: 'ポイント消費',
            display_channel_id: '',  // 表示チャンネル用
            notification_channel_id: '', // 通知チャンネル用
            mention_role_ids: [],
            use_thread: false,
        ...
        return {
            ...
            point_consumption: feature_settings.point_consumption || defaultPointConsumption,
    ...
    // デバッグ用ログ
    // console.log('FeatureSettings - serverData:', serverData);
    // console.log('FeatureSettings - serverRoles:', serverRoles);
    console.log('FeatureSettings - pointConsumption:', point_consumption);
